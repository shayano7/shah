...
..:::::..:::::::::::..:::::..::::::::::::......:::
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m shah-jehan
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m+92315×××××
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1mshahXjehan
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #shah jehan
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=1119646080")
		exit()
	else:
		os.system("https://www.facebook.com/profile.php?id=1119646080")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [shah jehan] %s/%s  OK*%s | OK*%s => %s%s%s'%(bi,loop,len(id2),ok,OK,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [shah jehan-OK] %s|%s        '%(b,idf,pw))
